...
public class FXMLAnchorPaneRelatorioQuantidadeProdutoController implements Initializable {
    ...
    @FXML
    private TableColumn<Produto, Integer> tableColumnProdutoCategoria;

    @FXML
    private Button buttonImprimir;

    private List<Produto> listProdutos;
    ObservableList<Produto> observableListProdutos;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        carregarTableViewProddutos();
    }    
    
    public void carregarTableViewProddutos() {
